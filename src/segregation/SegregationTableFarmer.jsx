...
export default function SegregationTableFarmer() {
    const location = useLocation();
    const params = new URLSearchParams(location.search);
    const farmerStockId = params.get("farmerFormId");// Extract farmerStockId from URL
...
const fetchCashStockData = async () => {
    ...
    return (
        <Layout>
            <div>
                <h2>Segregation Farmer Details</h2>
