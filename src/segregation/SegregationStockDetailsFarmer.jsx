...
const SegregationStockDetailsFarmer = ({ stockData }) => {
    ...
    const handleExpand = (stock) => {
      ...
      if (farmerFormId) {
          navigate(`/segregation-table-farmer?farmerFormId=${farmerFormId}&stockData=${stockObject}`);
      } else {
...
export default SegregationStockDetailsFarmer;
