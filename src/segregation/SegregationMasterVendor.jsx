...
import SegregationStockDetailsVendor from './SegregationStockDetailsVendor';

const SegregationMasterVendor = () => {
  const { vendorId } = useParams(); // Use useParams correctly
                ...
                <tr>
                  <td colSpan="7">
                    {expandedUnitType === 'bag' ? (
                      <SegregationStockDetailsVendor stockData={stockData[item._id]} />
                    ) : null}
                  </td>
                </tr>
              )}
...
export default SegregationMasterVendor;
