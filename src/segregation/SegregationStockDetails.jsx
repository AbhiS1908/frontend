...
const SegregationStockDetails = ({ stockData }) => {
    ...
    const handleExpand = (stock) => {
      ...
      if (cashFormId) {
          navigate(`/segregation-table-cash?cashFormId=${cashFormId}&stockData=${stockObject}`);
      } else {
...
export default SegregationStockDetails;
