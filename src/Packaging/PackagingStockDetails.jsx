...
const PackagingStockDetails = ({ row, _id }) => {
    ...
    useEffect(() => {
      ...
      return (
        <div style={modalContentStyle}>
          <h2 style={modalHeaderStyle}>Details for {row.cashName || row.name}</h2>
          <div style={gridContainerStyle}>
            <div style={gridStyle}>
              {/* Always displayed fields */}
              <div style={fieldStyle}>
                <strong>Name:</strong> {stockDetails.cashName || stockDetails.name}
              </div>
...
export default PackagingStockDetails;
