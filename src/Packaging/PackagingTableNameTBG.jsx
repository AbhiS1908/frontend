...
export default function PackagingTableNameTBG() {
  ...
  const handleSave = async (id) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/api/v1/auth/sutta-cash-one', {
  ...
  const handleUpdate = async (id) => {
    ...
    try {
      ...
      const response = await axios.put(`http://localhost:8000/api/v1/auth/sutta-cash-one/${id}`, {
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(`http://localhost:8000/api/v1/auth/sutta-cash-one/${deleteId}`);
  ...
  const handleStockOut = async (id) => {
    try {
      await axios.put(`http://localhost:8000/api/v1/auth/sutta-cash-stock-out-one/${id}`);
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(`http://localhost:8000/api/v1/auth/sutta-cash-one/${cashStockId}`);
      if (response.data) {
