...
import PacketStockDetails from './PacketStockDetails';

const PacketMasterCash = () => {
                ...
                <tr>
                  <td colSpan="7">
                    {expandedUnitType === 'bag' ? (
                      <PacketStockDetails stockData={stockData[item._id]} />
                    ) : null}
                  </td>
                </tr>
              )}
...
export default PacketMasterCash;
