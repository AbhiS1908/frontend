...
const PacketTableFarmer = () => {
  ...
  // State for editing product entries
  ...
  const fetchProductEntries = async (farmerStockDetailsId) => {
    try {
      ...
      setProductEntries((prev) => ({
        ...prev,
        [farmerStockDetailsId]: response.data,
      }));
    } catch (error) {
  ...
  const handleProductEntrySave = async (farmerStockDetailsId, index) => {
    try {
      const payload = {
      ...
      setDisabledProductRows((prev) => ({
        ...prev,
        [`${farmerStockDetailsId}-${index}`]: true,
      }));
  ...
  // Function to handle editing a product entry
  ...
  // Function to handle updating a product entry
  const handleProductEntryUpdate = async (farmerStockDetailsId, entryId) => {
    try {
      const payload = {
  ...
  const handleAddProductClick = (index, farmerStockDetailsId) => {
...
export default PacketTableFarmer;