...
const PacketStockDetailsFarmer = ({ stockData }) => {
    ...
    const handleExpand = (stock) => {
      ...
      if (farmerFormId) {
          navigate(`/packet-table-farmer?farmerFormId=${farmerFormId}&stockData=${stockObject}`);
      } else {
...
export default PacketStockDetailsFarmer;
