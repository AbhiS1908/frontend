...
const EditComponentPLSDFarmer = ({ stock, onClose, onUpdateSuccess }) => {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.put(
        `http://localhost:8000/api/v1/auth/farmer-stock/${stock._id}`,
        formData
      );
    ...
    <div style={modalStyles.overlay}>
      <div style={modalStyles.modal}>
        ...
        <div style={modalStyles.inputGroup}>
          <label style={modalStyles.label}>Particular:</label>
          <input
            type="text"
            name="particular"
...
export default EditComponentPLSDFarmer;