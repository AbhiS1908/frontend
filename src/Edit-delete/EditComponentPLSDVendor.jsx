...
const EditComponentPLSDVendor = ({ stock, onClose, onUpdateSuccess }) => {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.put(
        `http://localhost:8000/api/v1/auth/vendor-stock/${stock._id}`,
        formData
      );
...
export default EditComponentPLSDVendor;