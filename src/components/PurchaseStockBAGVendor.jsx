...
const PurchaseStockBAGVendor = ({ vendorFormId }) => {
  ...
  const handleSave = async (row, index) => {
    ...
    try {
      const response = await fetch("https://ane-production.up.railway.app/api/v1/auth/vendor-stock", {
        method: "POST",
        headers: {
...
export default PurchaseStockBAGVendor;