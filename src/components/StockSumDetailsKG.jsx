...
import EditComponentPLSDKGCash from '../Edit-delete/EditComponentPLSDKGCash';

const StockSumDetailsKG = ({ stockData, setStockData }) => {
    ...
    const handleDeleteClick = async (stockId) => {
      ...
      setLoading(true);
      try {
          await axios.delete(`http://localhost:8000/api/v1/auth/cash-stock/${stockId}`);
...
export default StockSumDetailsKG;
