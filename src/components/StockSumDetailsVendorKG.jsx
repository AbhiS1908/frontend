...
import EditComponentPLSDKGVendor from '../Edit-delete/EditComponentPLSDKGVendor';
const StockSumDetailsVendorKG = ({ stockData,vendorFormId, fetchStockData }) => {
...
export default StockSumDetailsVendorKG;
